                ...
                <div class="wg-box">
                    ...
                    <fieldset>
                        ...
                        <div class="upload-image mb-16"> 
                            ...
                            @foreach ( explode(',', $product->images) as $img)
                               ...
                               <img src="{{asset('uploads/products/'.$img)}}"  class="effect8" alt="{{ $product->name }}">
                                </div>  
                            @endforeach
                            }
                            @endif                      
                    ...
                    <div class="cols gap22">
                        <fieldset class="name">                                                
                            ...
                            <input class="mb-10" type="text" placeholder="Enter SKU" name="SKU" tabindex="0" value="{{ $product->SKU }}" id="SKU"aria-required="true">                                              
                        </fieldset>
                    ...
                    <div class="cols gap10">
                        <button class="tf-button w-full" type="submit">Updated product</button>                                            
                    </div>
                </div>
            </form>
            <!-- /form-add-product -->
