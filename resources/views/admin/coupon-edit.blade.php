    ...
    <div class="main-content-wrap">
        ...
        <div class="wg-box">
            <form class="form-new-product form-style-1" method="POST" action="{{ route('admin.coupon.update') }}">
                ...
                @error('code') <spann class="alert alert-danger text-center">{{ $message }}</spann>  @enderror
                ...
                @error('type') <spann class="alert alert-danger text-center">{{ $message }}</spann>  @enderror
                <fieldset class="name">
                ...
                @error('value') <spann class="alert alert-danger text-center">{{ $message }}</spann>  @enderror
                <fieldset class="name">
                ...
                @error('cart_value') <spann class="alert alert-danger text-center">{{ $message }}</spann>  @enderror
                <fieldset class="name">
                ...
                @error('expiry_date') <spann class="alert alert-danger text-center">{{ $message }}</spann>  @enderror
                <div class="bot">
                    <div></div>
                  
                 
                    <button type="submit" class="tf-button w208" type="submit">Save</button>
