...
<main class="pt-90">
    ...
    <section class="shop-checkout container">
      ...
      <div class="shopping-cart">
          ...
          <table class="cart-table">
            ...
            <tbody>
               ...
               <tr>
                ...
                <td>
                  <form action="{{ route('cart.item.remove', $item->rowId) }}" method="post" class="remove-cart-form">
                    @csrf
                    @method('DELETE')
        ...
        @else
            <div class="row">
                <div class="cols-md-12 text-center pt-5 bp-5">
                    <p>No item foun in your cart</p>
...
<script>
  $(function(){
    ...
    $(".remove-cart-form button").on("click", function(e) {
