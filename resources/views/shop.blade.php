...
@section('content')
  <style>
    .brands-list li, .category-list li{
      line-height: 40px
    }
    .brand-list .chk-brand, .category-list li .chk-category{
      width:1rem;
      height:1rem;
      color: $e4e4e4;
...
<main class="pt-90">
                  ...
                  <li class="list-item">
                     <span class="menu-link py-1">
                        <input type="checkbox" name="brands" value="{{$brand->id}}" class="chk-brand"
                         @if(in_array($brand->id,explode(',',$f_brands))) checked="checked" @endif>{{-- explode the contents of an array of f_brands --}}
                        {{ $brand->name }}
                     </span>
      ...
      <div class="shop-list flex-grow-1">
        ...
        <div class="d-flex justify-content-between mb-4 pb-md-2">
          ...
          <div class="shop-acs d-flex align-items-center justify-content-between justify-content-md-end flex-grow-1 ">
            <select class="shop-acs__select form-select w-auto border-0 py-0 order-1 order-md-0 px-3" aria-label="Page Size" id="pagesize"
  ...
  {{-- dont add csrf if you dont want token or seesion to show in the address bar --}}
