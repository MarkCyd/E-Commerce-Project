          ...
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
              ...
              <div class="text-center">
                <a href="{{ route('shop.index', $category->id) }}" class="menu-link fw-medium">{{ $category->name }}</a>
              </div>
            </div>
              ...
              <div class="swiper-wrapper">
                ...
                <div class="swiper-slide product-card product-card_style3">
                  ...
                  <div class="pc__info position-relative">
                    <h6 class="pc__title"><a href="{{ route('shop.product.details', $sproduct->slug) }}">{{
                        $sproduct->name }}</a></h6>
                    <div class="product-card__price d-flex">
                      <span class="money price text-secondary">
                        @if($sproduct->sale_price)
                        <s>${{$sproduct->regular_price}}</s> ${{$sproduct->sale_price}}
                        {{round(($sproduct->regular_price - $sproduct->sale_price)*100/$sproduct->regular_price)}} % OFF
                        @else
    ...
    <div class="row">
      ...
      <div class="col-6 col-md-4 col-lg-3">
        <div class="product-card product-card_style3 mb-3 mb-md-4 mb-xxl-5">
          ...
          <div class="pc__info position-relative">
            <h6 class="pc__title"><a href="{{ route('shop.product.details', $fproduct->slug) }}">{{ $fproduct->name
                }}</a></h6>
            <div class="product-card__price d-flex align-items-center">
              <span class="money price text-secondary">
                @if($fproduct->sale_price)
                <s>${{$fproduct->regular_price}}</s> ${{$fproduct->sale_price}} {{round(($fproduct->regular_price -
                $fproduct->sale_price)*100/$fproduct->regular_price)}} % OFF
                @else
